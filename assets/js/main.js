...
/*=============== SWIPER PLANETS ===============*/ 
var swiperTravel = new Swiper(".travel__swiper", {
    loop: true,
    spaceBetween: '32',
    grabCursor: true,
    slidesPerView: 'auto',
...
const scrollUp = () =>{
    ...
    // When the scroll is higher than 350 viewport height, add the show-scrollup class to the a tag with the scrollup class
